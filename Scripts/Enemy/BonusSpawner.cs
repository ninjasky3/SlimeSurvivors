...
public class BonusSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        if(RoundEnded)
        {
            gameManager.ActivateDoneBanner();
            uiGoldSprite.sprite = goldicon;
            ...
            if(bonusDone && enemiesAlive == 0)
            {
                gameManager.ChangeState(GameManager.GameState.LevelDone);
            }
